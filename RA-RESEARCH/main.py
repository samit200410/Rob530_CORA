...
def main():
    print("\n\nRUN BASELINE")
    run_baseline(BASE_KWARGS, "baseline2.pyfg", "baseline.pyfg")
    #print("\n\nRUN RSSI SWEEP")
    run_rssi_sweep()
    run_range_noise_sweep()
    run_noise_vs_rssi_sweep()
    ARGS2 = dict(
        sigma_dx=0.002,
        sigma_dy=0.002,
        sigma_dtheta=0.001,
    ...
    run_baseline(ARGS2,"range_0_5.pyfg", "rssi_0_5.pyfg",)
    ...
    run_baseline(ARGS3, "range_1.pyfg", "rssi_1.pyfg")
    ...
    run_baseline(ARGS4, "range_2.pyfg", "rssi_2.pyfg")
    ...
    run_baseline(ARGS5, "range_3.pyfg", "rssi_3.pyfg")
    ...
    run_baseline(ARGS6, "range_4.pyfg", "rssi_4.pyfg")
    ...
    run_baseline(ARGS7, "range_5.pyfg", "rssi_5.pyfg")
    ...
    run_baseline(ARGS8, "range_6.pyfg", "rssi_6.pyfg")
    ...
    run_baseline(ARGS9, "range_7.pyfg", "rssi_7.pyfg")
    ...
    run_baseline(ARGS10, "range_8.pyfg", "rssi_8.pyfg")
    ...
    run_baseline(ARGS11, "range_9.pyfg", "rssi_9.pyfg")
    ...
    run_baseline(ARGS12, "range_10.pyfg", "rssi_10.pyfg")
    ...
    run_baseline(ARGS13, "range_11.pyfg", "rssi_11.pyfg")
    ...
    run_baseline(ARGS14, "range_12.pyfg", "rssi_12.pyfg")
    ...
    run_baseline(ARGS15, "range_13.pyfg", "rssi_13.pyfg")
    ...
    run_baseline(ARGS16, "range_14_0.pyfg", "rssi_14_0.pyfg")
    ...
    run_baseline(ARGS17, "range_15_0.pyfg", "rssi_15_0.pyfg")

    run_experiment_baseline(ARGS17, "experiment.pyfg")
